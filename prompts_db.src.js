...
const allCases = [
    ...
    // ==========================================
    // 🚀 PRODUCTIVIDAD (101-110) - TEXTO ÍNTEGRO AGIA
    // ==========================================
    ...
    createCase(102, 'productivity', 'Ninja de Actas: De Reunión Eterna a Tareas Claras', 'groups', 'Gestión: Pérdida de tiempo en reuniones sin acuerdos claros.', 
        ...
        '{r}Eres un Project Manager experto en metodologías Ágiles.{/r} {c}Transcripción: [Insertar texto de Zoom/Teams o notas rápidas] Proyecto: [Nombre del Proyecto]{/c} {m}Extraer decisiones clave y asignar responsables para evitar el "reunionismo".{/m} {l}- No uses prosa larga. - Identifica "Bloqueadores" (lo que impide avanzar). - Usa un tono ejecutivo.{/l} {f}- Resumen en 1 frase. - Lista de DECISIONES TOMADAS. - Tabla de TAREAS: [Tarea] | [Responsable] | [Plazo].{/f}', 
        'Information Extraction & Structured Output (Fuerza a la IA a ignorar el \'ruido\' y enfocarse en datos accionables).', '¿Si alguien no fue a la reunión, entiende perfectamente qué debe hacer?', 
        '<div class="text-[10px]"><p><strong>Resumen:</strong> Se aprueba el aumento de presupuesto para Ads pero se pausa el diseño de la web.</p><p class="mt-1 font-bold">Decisiones Clave:</p><ul class="list-disc ml-3"><li>No se contratará agencia externa este mes.</li><li>El lanzamiento se mueve al 15 de enero.</li></ul><table class="w-full mt-1 border border-slate-200 border-collapse"><thead class="bg-slate-50"><tr><th class="border p-1">Tarea</th><th class="border p-1">Responsable</th><th class="border p-1">Plazo</th></tr></thead><tbody><tr><td class="border p-1">Ajustar presupuesto en Excel</td><td class="border p-1">Pedro</td><td class="border p-1">Lunes</td></tr><tr><td class="border p-1">Enviar diseño final a imprenta</td><td class="border p-1">Carola</td><td class="border p-1">Miércoles</td></tr><tr><td class="border p-1">Dejar constancia en Carabineros por pérdida de equipo</td><td class="border p-1">Don Lucho</td><td class="border p-1">Mañana</td></tr></tbody></table></div>', 'chatgpt', false, false, 'intermediate'),

    createCase(103, 'productivity', 'El Explicador "Feynman": Aprende lo que sea en minutos', 'psychology', 'Aprendizaje: Conceptos complejos difíciles de asimilar o explicar.', 
        'Explícame qué es el Blockchain.',
        '<div class="text-xs text-slate-500 italic">"El blockchain es un libro de contabilidad digital descentralizado que registra transacciones en muchas computadoras para que el registro no se pueda alterar retroactivamente."</div>', 
        '{r}Eres un profesor experto en pedagogía simple (Técnica Feynman).{/r} {c}Tema complejo: [Ej: Cómo declarar impuestos en el SII / Qué es una API] Mi nivel: [Principiante absoluto / Dueño de negocio]{/c} {m}Explicar el concepto usando una analogía cotidiana para que lo entienda un niño de 10 años.{/m} {l}- Prohibido usar tecnicismos sin explicarlos. - Usa una analogía relacionada con el día a día (ej: una feria, un partido de fútbol, una junta de vecinos).{/l} {f}Analogía inicial + Concepto clave + Ejemplo práctico.{/f}', 
        'Analogical Reasoning (Mejora la retención de información vinculando datos nuevos a conceptos conocidos).', '¿Podrías explicarle esto a tu abuela o a tu hija de 4 años y que lo entiendan?', 
        '<div class="p-2 bg-yellow-50 border border-yellow-200 text-[10px] rounded"><p><strong>El SII explicado como una Junta de Vecinos:</strong></p><p>Imagínate que vives en una comunidad. Para que las luces de la calle funcionen y la plaza esté bonita, todos deben poner una cuota mensual. El SII es como el "Tesorero" de la junta de vecinos.</p><p class="mt-1"><strong>Concepto Clave:</strong> Él revisa cuánto dinero ganaste (tus boletas) para decirte cuánto toca poner para la plaza (los impuestos).</p><p class="mt-1"><strong>Ejemplo Práctico:</strong> Si vendiste 10 tortas, el SII sabe que ganaste $100.000. Te dice: "De esos $100.000, $19.000 son el IVA (la cuota de la plaza)". No es dinero tuyo, solo lo estás guardando para entregárselo a él.</p></div>', 'gemini', false, false, 'beginner'),
    ...
    createCase(104, 'productivity', 'Estructurador de Cursos Relámpago', 'school', 'Educación: Planificación lenta de currículos educativos.', 
        ...
        '{r}Eres un Diseñador Instruccional experto en Micro-learning.{/r} {c}Nombre del Curso: [Aula GenIA: IA para emprendedores] Público: [Dueños de pyme que no saben programar] Duración total: [4 semanas]{/c} {m}Crear un currículo que garantice que el alumno aplique lo aprendido el mismo día.{/m} {l}- Cada módulo debe tener un "Entregable Práctico". - Tono: Motivador y directo.{/l} {f}Lista por semanas: [Semana] | [Tema] | [Proyecto Práctico del alumno].{/f}', 
        'Backward Design (Planifica desde el resultado deseado hacia atrás para asegurar utilidad).', '¿El alumno termina el curso con algo real construido?', 
        '<div class="text-[10px]"><p class="font-bold mb-1">Estructura de "Aula GenIA" (4 Semanas):</p><table class="w-full border border-collapse text-left"><thead><tr class="bg-indigo-50"><th>Semana</th><th>Tema</th><th>Proyecto Práctico</th></tr></thead><tbody><tr><td>1</td><td>Domando a la IA: Prompts de Oro</td><td>Crear un asistente que redacte tus correos de venta.</td></tr><tr><td>2</td><td>Imágenes que Venden (Canva + AI)</td><td>Diseñar 3 posts de Instagram con modelos generados por IA.</td></tr><tr><td>3</td><td>Automatización con WhatsApp</td><td>Configurar respuestas automáticas para preguntas de precio.</td></tr><tr><td>4</td><td>Análisis de Negocio Express</td><td>Subir tu Excel de ventas y pedirle a la IA que encuentre tus fugas de plata.</td></tr></tbody></table></div>', 'chatgpt', false, false, 'intermediate'),
    ...
    createCase(105, 'productivity', 'Asistente de Informes "Cero Paja"', 'description', 'Reportabilidad: Informes largos, aburridos y poco accionables.', 
        ...
        '<div class="text-xs text-slate-500 italic">"Las ventas este mes fueron buenas. Subieron un 10% respecto al mes pasado. Estamos contentos y esperamos seguir así."</div>', 
        '{r}Consultor de Estrategia de Negocios.{/r} {c}Datos brutos: [Ventas: $5M, Gastos: $2M, Cliente principal: Pyme X] Objetivo: [Presentar a socios]{/c} {m}Convertir números fríos en una narrativa de crecimiento y detección de riesgos.{/m} {l}- Usa el formato BLUF (Bottom Line Up Front): La conclusión va al principio. - Sin palabras de relleno como "estimados", "consideramos".{/l} {f}Resumen Ejecutivo + 3 Insights Clave + 2 Próximos Pasos.{/f}', 
        'BLUF Strategy (Prioriza la información crítica para ahorrar tiempo a los lectores).', '¿Si el jefe solo lee el primer párrafo, se entera de todo lo importante?', 
        '<div class="bg-white p-2 border shadow-sm text-[10px]"><p><strong>RESUMEN EJECUTIVO (BLUF):</strong> Cerramos el mes con una utilidad neta de $3M (60% de margen), superando la meta en un 15%.</p><p class="mt-1 font-bold">Insights Clave:</p><ul class="list-disc ml-3"><li><strong>Eficiencia:</strong> Los gastos se mantuvieron estables.</li><li><strong>Concentración:</strong> El 40% de ingresos depende de "Pyme X"; riesgo alto.</li><li><strong>Canal:</strong> TikTok generó más leads que Instagram.</li></ul><p class="mt-1 font-bold">Próximos Pasos:</p><ol class="list-decimal ml-3"><li>Diversificar cartera: Captar 2 clientes nuevos.</li><li>Reasignar presupuesto de Ads a TikTok.</li></ol></div>', 'gemini', false, false, 'advanced'),

    createCase(106, 'productivity', 'Planificador de Jornada "Anti-Procrastinación"', 'schedule', 'Gestión: Listas de tareas infinitas que generan parálisis.', 
        ...
        '{r}Coach de Productividad experto en Time Blocking y Técnica Pomodoro.{/r} {c}Tareas: [Ej: Grabar videos TikTok, pagar cuentas, ver curso Aula GenIA, llevar hija al jardín] Energía: [Soy más productivo de 9am a 12pm]{/c} {m}Crear un horario realista que proteja mis "bloques de enfoque".{/m} {l}- Incluye "Tiempos de Buffer" (descanso/imprevistos). - Prioriza la tarea más difícil (Eat the Frog) temprano.{/l} {f}Horario detallado con duración y tipo de energía requerida.{/f}', 
        'Time Blocking & Energy Mapping (Optimiza no solo el tiempo, sino la capacidad mental disponible).', '¿Sientes que el horario es realista o te estresa solo verlo?', 
        '<div class="text-[10px] space-y-1"><p class="font-bold">Tu Plan Maestro de Mañana:</p><ul><li><strong>08:30 - 09:00:</strong> Logística familiar (Llevar hija al jardín). <em>Energía: Baja.</em></li><li><strong>09:15 - 11:15:</strong> 🧠 <strong>BLOQUE PROFUNDO:</strong> Grabar 5 videos de TikTok. <em>Energía: Máxima.</em></li><li><strong>11:15 - 11:45:</strong> Break & Buffer (Estirarse, café, imprevistos).</li><li><strong>11:45 - 13:00:</strong> Trabajo Administrativo (Pagar cuentas). <em>Energía: Media.</em></li><li><strong>13:00 - 14:00:</strong> Almuerzo (Lejos de la pantalla).</li><li><strong>14:00 - 15:30:</strong> Formación: Ver 2 módulos de Aula GenIA. <em>Energía: Media-Baja.</em></li></ul></div>', 'chatgpt', false, false, 'beginner'),

    createCase(107, 'productivity', 'Traductor de Jerga Legal (Contratos)', 'gavel', 'Legal: Dificultad para entender contratos y riesgos legales.', 
        ...
        '{r}Abogado experto en contratos civiles (Chile).{/r} {c}Documento: [Pega las cláusulas del contrato] Mi rol: [Arrendatario / Prestador de servicios]{/c} {m}Identificar cláusulas abusivas, multas escondidas y fechas críticas.{/m} {l}- Explica como si fuera una conversación de café. - Resalta lo que NO me conviene.{/l} {f}Semáforo de Riesgo: [Verde: Ok] | [Amarillo: Cuidado] | [Rojo: Peligro/Negociar].{/f}', 
        'Risk Assessment Prompting (Enfoca la atención de la IA en anomalías y peligros potenciales).', '¿Sabes exactamente qué frase pedir que cambien en el contrato?', 
        '<div class="text-[10px] space-y-1"><p class="font-bold">Análisis de tu Contrato de Arriendo:</p><div>🟢 <strong>Verde:</strong> El reajuste por IPC es semestral, lo cual es estándar y justo.</div><div>🟡 <strong>Amarillo:</strong> Dice que debes avisar con 60 días si te vas. Lo normal son 30.</div><div>🔴 <strong>Rojo:</strong> Cláusula permite al dueño entrar "cuando quiera". <strong>Esto es ilegal.</strong></div><p class="mt-1 italic"><strong>Fechas Críticas:</strong> Pago hasta el 5, al día 6 te cobran 1% diario de multa.</p></div>', 'perplexity', false, false, 'advanced'),

    createCase(108, 'productivity', 'Generador de Presentaciones Express', 'slideshow', 'Diseño: Diapositivas con mucho texto que nadie lee.', 
        'Hazme una presentación sobre marketing digital.',
        '<div class="text-xs text-slate-500 italic">"Diapositiva 1: Título. Diapositiva 2: Qué es marketing. Diapositiva 3: Redes sociales. Diapositiva 4: SEO. Diapositiva 5: Gracias."</div>', 
        '{r}Eres un Diseñador de Presentaciones de Storytelling (estilo TED Talk).{/r} {c}Tema: [Cómo usar IA en el teletrabajo] Audiencia: [Jefes de área tradicionales]{/c} {m}Crear una estructura de 7 diapositivas que no aburran y convenzan de adoptar la IA.{/m} {l}- Cada diapositiva debe tener un "Concepto Visual" sugerido. - Máximo 20 palabras por slide.{/l} {f}[Slide #] | [Título Impactante] | [Guion del orador] | [Imagen sugerida].{/f}', 
        'Visual Metaphor & Storylining (Crea una estructura narrativa en lugar de solo listar datos).', '¿La presentación cuenta una historia o es solo una lista de supermercado?', 
        '<div class="overflow-x-auto text-[9px]"><p class="font-bold mb-1">Presentación: El Futuro es Hoy (IA)</p><table class="w-full border border-collapse"><thead><tr class="bg-slate-50"><th>Slide</th><th>Título Impactante</th><th>Guion del Orador</th><th>Imagen Sugerida</th></tr></thead><tbody><tr><td class="border p-1">1</td><td class="border p-1">No es magia, es ahorro.</td><td class="border p-1">"Hoy no vengo a hablar de robots, sino de cómo ganar 2 horas de vida al día."</td><td class="border p-1">Una persona cerrando su laptop feliz al atardecer.</td></tr><tr><td class="border p-1">2</td><td class="border p-1">El Excel ya no es suficiente.</td><td class="border p-1">"Seguimos usando herramientas del 2005 para problemas del 2025."</td><td class="border p-1">Un dinosaurio usando una máquina de escribir.</td></tr><tr><td class="border p-1">3</td><td class="border p-1">Tu nuevo asistente 24/7.</td><td class="border p-1">"La IA no te va a reemplazar, pero alguien que sabe usarla sí."</td><td class="border p-1">Dos manos estrechándose, una humana y una robótica.</td></tr></tbody></table></div>', 'gamma', false, false, 'intermediate'),

    createCase(109, 'productivity', 'Asistente de Compras "Smart Buyer"', 'shopping_cart', 'Investigación: Parálisis por exceso de opciones al comprar tecnología.', 
        'Dime cuál es la mejor lavadora-secadora.',
        '<div class="text-xs text-slate-500 italic">"La LG WashTower y la Samsung WD22 son buenas opciones. Tienen buena capacidad y ahorro de energía."</div>', 
        '{r}Experto en Consumer Reports y Tecnología de Hogar.{/r} {c}Producto: [Lavadora-Secadora Premium] Presupuesto: [Ej: 800.000 - 1.200.000 CLP] Prioridad: [Que no meta ruido porque teletrabajo / Que se conecte al celu]{/c} {m}Comparar los 3 mejores modelos disponibles en Chile y dar un veredicto basado en durabilidad.{/m} {l}- Considera el servicio técnico en Chile. - Menciona una "Contra" real de cada modelo.{/l} {f}Tabla Comparativa + Veredicto: "La que yo compraría".{/f}', 
        'Critique-Based Comparison (Obliga a la IA a buscar puntos débiles, no solo marketing).', '¿Te ahorró leer 50 comentarios en Falabella o Mercado Libre?', 
        '<div class="text-[10px]"><p class="font-bold mb-1">Comparativa de Lavadoras-Secadoras (Gama Alta):</p><table class="w-full border border-collapse"><thead><tr class="bg-slate-50"><th>Modelo</th><th>Fortalezas</th><th>Debilidad Real</th><th>Ruido</th></tr></thead><tbody><tr><td class="border p-1"><strong>LG WashTower</strong></td><td class="border p-1">Diseño compacto, IA detecta tela.</td><td class="border p-1">Muy pesada para moverla.</td><td class="border p-1">Ultra silenciosa.</td></tr><tr><td class="border p-1"><strong>Samsung WD22</strong></td><td class="border p-1">Carga gigante (22kg).</td><td class="border p-1">El secado demora más de lo que dicen.</td><td class="border p-1">Moderado.</td></tr><tr><td class="border p-1"><strong>Miele W1</strong></td><td class="border p-1">Dura 20 años.</td><td class="border p-1">Repuestos carísimos en Chile.</td><td class="border p-1">Silenciosa.</td></tr></tbody></table><p class="mt-2"><strong>Veredicto:</strong> Si teletrabajas, la <strong>LG WashTower</strong> es la ganadora. El motor Direct Drive casi no vibra.</p></div>', 'perplexity', false, false, 'intermediate'),

    createCase(110, 'productivity', 'Prompt de Limpieza de Bases de Datos (Excel)', 'data_table', 'Data: Bases de datos "sucias" que impiden trabajar en CRM.', 
        ...
        '{r}Analista de Datos Senior.{/r} {c}Datos sucios: [Pega aquí tu lista de contactos/ventas desordenada]{/c} {m}Normalizar los datos para que sean útiles en un CRM o envío masivo.{/m} {l}- Nombres: Primera letra en Mayúscula. - Teléfonos: Formato internacional +56 9 XXXX XXXX. - Identificar correos mal escritos (sin @ o sin .com).{/l} {f}Bloque de código CSV (para copiar y pegar en Excel).{/f}', 
        'Data Normalization & Pattern Recognition (Usa reglas lógicas para estandarizar información dispersa).', '¿Puedes importar este resultado directamente a tu Excel sin errores?', 
        '<div class="bg-slate-900 text-green-400 p-2 font-mono text-[9px] rounded"><p>Nombre,Telefono,Email,Estado</p><p>Juan Perez,+56 9 1234 5678,juan@gmail.com,OK</p><p>Maria Paz,+56 9 8765 4321,m.paz@outlook.com,OK</p><p>Luis Soto,+56 9 5555 4444,lsoto(at)web.cl,ERROR_EMAIL</p><p class="mt-1 text-slate-400 italic">*Nota: He corregido 4 teléfonos que no tenían el código de Chile.*</p></div>', 'chatgpt', false, false, 'intermediate'),
